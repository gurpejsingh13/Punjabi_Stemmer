...
{"match": "ਸ਼ਾਲਾ", "strip": "ਸ਼ਾਲਾ", "add": "ਸ਼ਾਲਾ"}, # ਗਊਸ਼ਾਲਾ if we don't remove or add same suffix then stemmmer will continue steming
                                                  # because input word is valid but now we are converting it to stem word valid so no
...
{"match": "ੀਏ", "strip": "ਏ", "add": ""},
                       {"match": "ੀਏ", "strip": "ਏ", "add": "ਆ"},# ਏਰੀਏ , ਮੀਡੀਏ although it look like suffix is
                                                                   # getting added but  thats not the case adding this word as suffix
                                                                    #here in word makes it to root form
...
{"match": "ੋ ਂ", "strip": "ੋ ਂ", "add": ""}
    ...
    def preprocess_text(self, text):
        """
        Removes punctuation, special characters, and emojis from the text, preserving
        Punjabi characters, numbers, and words from other languages.
        """
        text = text.replace('_', ' ')
